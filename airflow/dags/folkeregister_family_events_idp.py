"""
Airflow DAG — Kafka IDP: folkeregister_family_events_idp
Mal: kafka_idp
...
Target: s3a://bronze/folkeregister/family_events
...
KAFKA_TOPICS    = "folkeregister.event.marriage,folkeregister.event.divorce,folkeregister.event.birth"
TARGET_PATH     = "s3a://bronze/folkeregister/family_events"
CHECKPOINT_PATH = "s3a://checkpoints/folkeregister_family_events_idp"
CONSUMER_GROUP  = "folkeregister-family-events-idp"
PRODUCT_ID      = "folkeregister.family_events"
PRODUCT_NAME    = "Folkeregister — Familiehendelser (IDP)"
...
SPARK_APP_NAME  = "folkeregister-family-events-idp-streaming"
...
def register_product(**context):
    ...
    manifest = {
        ...
        "owner":        OWNER,
        "version":      "1.0.0",
        "description":  "Kildenær IDP som konsumerer familiehendelser fra Folkeregisteret via Kafka. "
        ...
        "format":       "delta",
        "dag_id":       "folkeregister_family_events_idp",
        "product_type": "source",
        "access":       "restricted",
    ...
    try:
        ...
        requests.patch(
            ...
            json={"dag_id": "folkeregister_family_events_idp"},
...
with DAG(
    dag_id="folkeregister_family_events_idp",
    description="Kafka IDP: folkeregister familie-hendelser → Bronze",
    schedule="@once",
